...
?>
  <div class="wrap dsgvoyoutube_box">
    ...
    <p>
      <?php
      printf(
        __('I hope you like my plugin, and I would appreciate it if you could leave a <a href="%s" target="_blank">review</a>.', 'dsgvo-youtube'),
        esc_url('https://wordpress.org/support/plugin/dsgvo-youtube/reviews/#new-post')
      );
      ?>
    </p>
  </div>
...
function showForm_dsgvoyoutube()
{
  ...
  echo '<h3 id="bgselector">Background Color Selector</h3>';
  ...
  <div class="wrap dsgvoyoutube_box">
    <h3><?php _e('Support', 'dsgvo-youtube'); ?></h3>
